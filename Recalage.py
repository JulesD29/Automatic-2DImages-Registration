...
str_FixeFilename = r'fichiersEtudiants\result_moved_slice14_5_8.nii'
...
str_MobileFilename = r'fichiersEtudiants\result_moved_slice14_5_8_moved.nii'
...
#Initialisations
list_Trans = [0,0]
int_NbIterations = 300
float_PasIteration = 0.0005
int_ItCounter = 0
...
plt.plot(list_Iteration, list_Dissim, label = 'Pas :' + str(float_PasIteration))
